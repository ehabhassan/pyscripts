...
def read_profiles(profilesfpath,setParam={},Zeffprofile=True,**kwargs):
    ...
    if   interpflag:
         if   rhopsiflag:
              ...
              PROFILESdata['Er']       = mathtools.interp(PROFILESdata['PSIN'],PROFILESdata['Er'],psi)
              ...
              PROFILESdata['Er']       = mathtools.interp(PROFILESdata['PSIN'],PROFILESdata['Er'],psi,phi,phi)
